...
if (room == Room2) {
	draw_text(16,16,string_join("","Wallet: ","$",global.allmoney));
	draw_text(16,745,"Released and Developed by OPagel");
	draw_text(850,745,"v1.2.0");
}
if (room == Room1) {
...
draw_text(864, 690, string_join("","$",global.money));
...
if (global.hp < 1) {
	...
	draw_text(350,580,string_join(": ", "Money Earned", global.money));
	...
	draw_text(410,540,"UPGRADES");
	if (keyboard_check_pressed(vk_down) || keyboard_check_pressed(ord("S")) || (gamepad_axis_value(0,gp_axislv) > 0)) || (mouse_wheel_down()) {
	...
	if (keyboard_check_pressed(vk_up) || keyboard_check_pressed(ord("W")) || (gamepad_axis_value(0,gp_axislv) < 0)) || (mouse_wheel_up()) {
